...
int main(int argc, char *argv[])
{
	...
	actuatorManager.addBoneLink(actuatorManager.addActuator(Movement::LinearActuator<>(Common::Vector3F(0.0, 0.0, 0.0), Common::Vector3F(10.0, 10.0, 10.0))), skeletal.Arms[0]);
