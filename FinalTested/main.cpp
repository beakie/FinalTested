...
int main(int argc, char *argv[])
{
	...
	Drawing::Image8RGBPixel8 testImageJET = Drawing::Image8Render::convImageToTriChanImage<Float32, Drawing::TriChanPixel<UInt8>>(testImage, &Drawing::TriColorMap32Conv8(&map, 0.0, 1.0));
